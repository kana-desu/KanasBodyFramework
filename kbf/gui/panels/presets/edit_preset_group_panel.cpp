    ...
    void EditPresetGroupPanel::openCopyPresetGroupPanel() {
        ...
        copyPresetGroupPanel.get()->onSelectPresetGroup([&](std::string uuid) {
            ...
            if (copyPresetGroup) {
                ...
                DEBUG_STACK.push(std::format("{} Could not find preset group with UUID {} while trying to make a copy.", EDIT_PRESET_GROUP_PANEL_LOG_TAG, uuid), DebugStack::Color::COL_ERROR);
            }
